...
references: 
    ...
    - type: website
      url: "https://github.com/eclipse-score/inc_nlohmann_json/blob/save_historical_data/TSF/data_storage"
      description: "the folder that contains databases containing the trustable scores"
evidence:
