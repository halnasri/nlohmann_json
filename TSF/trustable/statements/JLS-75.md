...
Static code analysis and sanitizer checks are part of the project’s quality assurance, and no findings trends are reported beyond what can be observed from the CI run history.
